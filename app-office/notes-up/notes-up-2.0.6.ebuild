...
SRC_URI="https://github.com/ilhooq/Notes-up/archive/refs/tags/2.0.6-sort-items.tar.gz"

S="${WORKDIR}/Notes-up-2.0.6-sort-items"
...
DEPEND="
	...
	>=net-libs/webkit-gtk-2.36.7:4[introspection]
	dev-db/sqlite
